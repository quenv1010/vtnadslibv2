...
class AppPurchaseImpl extends AppPurchase {
    ...
    private static AppPurchaseImpl instance;
    ...
    public static AppPurchaseImpl getInstance() {
        if (instance == null) {
            instance = new AppPurchaseImpl();
        }
        return instance;
    }
...
//    }
    ...
    @Override
    public String getFormattedPriceIAP(String productId) {
        ProductDetails productDetails = skuDetailsINAPMap.get(productId);
        if (productDetails == null)
            return "";
        if (productDetails.getOneTimePurchaseOfferDetails() == null) {
